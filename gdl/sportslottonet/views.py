...
from sportslottonet import library
from sportslottonet.library.datamap import SPORTS
...
def how_to_play(request):
    context = {}
    return render(request, 'sportslottonet/how_to_play/index.html', context)


def about_us(request):
    context = {}
    return render(request, 'sportslottonet/about_us/index.html', context)


def terms_conditions(request):
    context = {}
    return render(request, 'sportslottonet/terms_conditions/index.html', context)


def faq(request):
    context = {}
    return render(request, 'sportslottonet/faq/index.html', context)


def consolation_payout_table(request):
    context = {}
    return render(request, 'sportslottonet/consolation_payout_table/index.html', context)

def glossary(request):
    context = {}
    return render(request, 'sportslottonet/glossary/index.html', context)

def refer_a_friend(request):
    context = {}
    return render(request, 'sportslottonet/refer_a_friend/index.html', context)

def responsible_gaming(request):
    context = {}
    return render(request, 'sportslottonet/responsible_gaming/index.html', context)
def privacy(request):
    context = {}
    return render(request, 'sportslottonet/privacy/index.html', context)

def differences(request):
    context = {}
    return render(request, 'sportslottonet/differences/index.html', context)
def what_is_sportslotto(request):
    context = {}
    return render(request, 'sportslottonet/what_is_sportslotto/index.html', context)

def login_widget(request):
    theme = request.GET.get('theme', 'dark')
    url = f'https://play.sportslotto.net/widgets/account/login/?theme={theme}'
    try:
...
def index(request):
    ...
    # print(build_hero_rows())
    return render(request, "sportslottonet/home/index.html", context)
