...
def filter_settings_view_handle(request):
    ...
    return render(request, "solstic.gdl/gdlagent/filters_setting_view.html", context)
...
def user_filter_settings_view_handle(request):
    ...
    return render(request, "solstic.gdl/gdlagent/user_filters_setting_view.html", context)
