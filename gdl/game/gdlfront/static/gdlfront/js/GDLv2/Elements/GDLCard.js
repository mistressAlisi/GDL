...
export class ElementGDLCard extends _elementProto {
  ...
  _render() {
    ...
    this.spinnerArea = $("<div class=\"processing-overlay w-100 h-100 text-center\">\n <i class=\"top-50 fa-duotone fa-spinner fa-spin fa-4x text-primary position:\"></i>\n</div>", { class: "gdl-processing-overlay"});
    inner.append(front, back, this.spinnerArea);
    this.spinnerArea.hide();
    return col;
  }
  ...
  _render_back() {
    ...
    this.form.append($("<input/>",{"type":"hidden","id":"outcome_meta","name":"outcome_meta","value":JSON.stringify(this.data["outcome_meta"])}))
