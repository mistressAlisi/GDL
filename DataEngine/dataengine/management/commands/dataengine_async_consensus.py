...
from dataengine.consensus.daemon.main import AsyncConsensusDaemon
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # --- Initialize Engine ---
        engine = AsyncConsensusDaemon(vhost=vHost,logger=logging.getLogger("AsyncConsensusDaemon"))
