...
from dataengine.drivers.goalserve.daemon.goalserved import GoalServeD
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.MIGRATE_HEADING(
                f"DataEngine GoalServeD Async Daemon starting for {vHost}"
            )
        )
        ...
        # --- Initialize Engine ---
        engine = GoalServeD(vhost=vHost,logger=logging.getLogger("GoalServeD"))
