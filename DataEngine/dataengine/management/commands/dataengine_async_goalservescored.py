...
from dataengine.drivers.goalserve.daemon.goalservescored import GoalServeScoreD
    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.MIGRATE_HEADING(
                f"DataEngine GoalServeScoreD Async Daemon starting for {vHost}"
            )
        )
        ...
        # --- Initialize Engine ---
        engine = GoalServeScoreD(vhost=vHost,logger=logging.getLogger("GoalServeScoreD"))
