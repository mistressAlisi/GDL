    ...
    def handle(self, *args, **options):
        ...
        self.stdout.write(
            self.style.MIGRATE_HEADING(
                f"DataEngine APISports American Football Async Daemon starting for {vHost}"
            )
        )
        ...
        # --- Initialize Engine ---
        engine = APISportsAmericanFootballAsync(vhost=vHost,logger=logging.getLogger("APISportsAmericanFootballAsync"))
