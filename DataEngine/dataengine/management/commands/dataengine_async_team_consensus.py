...
from dataengine.consensus.daemon.teams import AsyncTeamLinkerDaemon
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # --- Initialize Engine ---
        engine = AsyncTeamLinkerDaemon(vhost=vHost,logger=logging.getLogger("AsyncTeamLinkerDaemon"))
        engine._child_init()
