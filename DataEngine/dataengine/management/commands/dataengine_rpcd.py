...
from dataengine.publisher.daemons.datarpcdaemon import DataPublisherRPCDaemon
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        # --- Initialize Engine ---
        engine = DataPublisherRPCDaemon(vhost=vHost,logger=logging.getLogger("DataPublisherRPCDaemon"))
