...
class Command(BaseCommand):
    help = 'ApiSports: All Supported Sports: Get the Players.'
    def add_arguments(self, parser):
        # Named (optional) arguments
        parser.add_argument("vhost",type=str,nargs="+")
        parser.add_argument("-l", type=str, nargs="+")
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS('Getting Teams!'))
        ...
        apidaemon.get_players()
        self.stdout.write(self.style.SUCCESS('Completed getting Players.'))
