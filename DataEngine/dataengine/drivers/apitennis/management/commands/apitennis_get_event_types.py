...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        apidaemon.get_event_types()
        self.stdout.write(self.style.SUCCESS('Completed getting event types!'))
