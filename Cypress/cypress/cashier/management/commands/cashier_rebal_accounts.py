...
class Command(BaseCommand):
    help = "Rebalance all Accounts' risk"
    ...
    def handle(self, *args, **options):
        ...
        engine._child_init()
        # -- Get Wagers ---
        self.stdout.write(self.style.MIGRATE_HEADING(f"Recomputing all accounts' risk balance."))
        loop = asyncio.new_event_loop()
        loop.run_until_complete(engine.rebalance_accounts_risk())
