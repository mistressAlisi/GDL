...
export const Balance: React.FC<BalanceProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 max-w-6xl mx-auto p-3 sm:p-4 md:p-6 pb-8">
        {/* Header */}
        <div className="mb-4 md:mb-6">
          <div className="flex items-center justify-between mb-2">
            <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold bg-gradient-to-r from-yellow-200 via-yellow-400 to-yellow-200 bg-clip-text text-transparent">
              Account Balance
            </h1>
            {onBackToMenu && (
              <motion.button
